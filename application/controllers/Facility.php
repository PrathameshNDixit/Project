...
class Facility extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('Facility/FacilityDetailsView', $data);
    ...
    public function create()
    {
        ...
        // $data['data'] = $obj;
        $this->load->view('common/header_view');
        $this->load->view('Facility/FacilityView');
        $this->load->view('common/footer_view');
    }
    function insertFacility()
    {
        $FacilityId = $this->input->post('FacilityId');
        $BanquetFacilityName = $this->input->post('BanquetFacilityName');
        $FacilityRate = $this->input->post('FacilityRate');
        $Description = $this->input->post('Description');

        $fields = array(
            
           'BanquetFacilityName' =>$BanquetFacilityName,
