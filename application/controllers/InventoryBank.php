...
class InventoryBank extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('InventoryBank/InventoryBankDetailsView', $data);
    ...
    public function create()
    {
        ...
        // $data['data'] = $obj;
        $this->load->view('common/header_view');
        $this->load->view('InventoryBank/InventoryBankView');
        $this->load->view('common/footer_view');
    }
    function insertInventoryBank()
    {
