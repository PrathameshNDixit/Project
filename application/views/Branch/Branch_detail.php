        ...
        <div class="main-content">
            ...
            <div class="row">
                                    ...
                                    <thead>
                                        <div class="addnewbutton">
                                            ...
                                            <button type="button" class=" btn Addnew"><a href="create"><i
                                                        class="fas fa-plus-circle animtxt"
                                                        aria-hidden="true"></i>&nbsp;Add New</a></button>
                                        </div>
                                        <tr>
                                            <!-- <th>Action</th>
                                            <th>Sr.No</th>
                ...
                <th>Photo</th> -->
                                    ...
                                    <tbody>
                                        <!-- <tr>
                                            <td><i class="far fa-edit fa-lg" style="color:#1977D3;"></i><a href="create"
                                                    data-mdb-toggle="tooltip" title="edit">&nbsp;Edit</a></td>
                                            <td>01</td>
                                        ...
                                        <!-- <td>Hindi</td>
                                            ...
                                            for ($i = 0; $i < count($data); $i++) {
                                                echo '<tr>';
                                                echo '<td><a href="' . base_url() . 'Branch/' . $data[$i]->branch_id . '"><i class="fas fa-eye" style="font-size: 16px;"></i></a></td>';
