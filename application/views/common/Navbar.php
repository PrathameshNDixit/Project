                ...
                <ul class="navbar-nav text-center ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" 
                                    href="<?php echo base_url() ?>index.php/RoomStatus/create">Room Status</a></li>
                            <li><a class="dropdown-item" 
                                    href="<?php echo base_url() ?>index.php/WakeupCall/create">Wakeup Call</a></li>
                            <li><a class="dropdown-item" 
                                    href="<?php echo base_url() ?>index.php/postalreceive/create">Postal Receive</a></li>
                            <li><a class="dropdown-item" 
                                    href="<?php echo base_url() ?>index.php/Customermsg/create">Staff/Customer Message</a></li>
                        </ul>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo base_url() ?>index.php/BanquestBooking/create">New Banquet Booking</a></li>
                            <li><a class="dropdown-item" href="<?php echo base_url() ?>index.php/BanquetPkg/create">Banquet Package Creation </a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item" href="#">Something else here</a></li>
