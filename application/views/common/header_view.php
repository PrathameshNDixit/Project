            ...
            <div class="header-part-right">
                ...
                <div class="dropdown container">
                    <div class="user col align-self-end">
                        <img src="<?= base_url(); ?>Assets/images/graduate.png" id="userDropdown" alt=""
                            data-toggle="dropdown" class="anim" aria-haspopup="true" aria-expanded="false">
        ...
        <div class="side-content-wrap">
            <div class="sidebar-left open rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                <ul class="navigation-left">
                    ...
                    <li class="nav-item" data-item="apps"><a class="nav-item-hold" href="<?= base_url() ?>Company"><img
                                height="25px" src="<?php echo base_url() ?>Assets\images\office-building.png "><span
            ...
            <div class="sidebar-left-secondary rtl-ps-none" data-perfect-scrollbar="" data-suppress-scroll-x="true">
                ...
                <ul class="childNav" data-parent="form">
                    <li class="nav-item"><i><b>Employee Module Masters</b></i></li>
                    <li class="nav-item"><a href="<?= base_url(); ?>Master/bldtype"><i class="fa-lg far fa-keyboard"
                                aria-hidden="true"></i><span class="item-name">&nbsp;Blood Group</span></a></li>
                    <li class="nav-item"><a href="<?= base_url(); ?>Master/emptype"><i class="fa-lg far fa-keyboard"
                                aria-hidden="true"></i><span class="item-name">&nbsp;Employee Type</span></a></li>
                    <li class="nav-item"><i><b>Company Module Masters</b></i></li>
                    <li class="nav-item"><a href="<?= base_url(); ?>Master/comptype"><i class="fa-lg fas fa-building"
                                aria-hidden="true"></i><span class="item-name">&nbsp;Company Type</span></a></li>
                    <li class="nav-item"><a href="<?= base_url(); ?>Master/branchlocation"><i
                                class="fa-lg fas fa-building" aria-hidden="true"></i><span
                                class="item-name">&nbsp;branchlocation</span></a></li>
                    <li class="nav-item"><i><b>Opening Module Masters</b></i></li>

                    <li class="nav-item"><a href="<?= base_url(); ?>Master/keytype"><i class="fa-lg far fa-keyboard"
                                aria-hidden="true"></i><span class="item-name">&nbsp;Keyword Type</span></a></li>
                    <li class="nav-item"><a href="<?= base_url(); ?>Master/qualification"><i
                                class="fa-lg fas fa-user-graduate" aria-hidden="true"></i><span
                                class="item-name">&nbsp;Qualification</span></a></li>

                    <li class="nav-item"><i><b>Others Module Masters</b></i></li>

                    <li class="nav-item"><a href="<?= base_url(); ?>Master/stream"><i class="fa-lg fas fa-user-graduate"
                                aria-hidden="true"></i><span class="item-name">&nbsp;Stream</span></a></li>

                    <li class="nav-item"><a href="<?= base_url(); ?>Master/term"><i class="fa-lg fas fa-calendar-alt"
                                aria-hidden="true"></i><span class="item-name">&nbsp;Term</span></a></li>

                    <li class="nav-item"><a href="<?= base_url(); ?>Role"><i class="fa-lg fa fa-user-circle"
                                aria-hidden="true"></i>&nbsp;&nbsp;<span class="item-name">Role</span></a></li>

                    <li class="nav-item"><a href="<?= base_url(); ?>Designation"><i class="fa-lg fa  fa-address-card"
                                aria-hidden="true"></i><span class="item-name">&nbsp;Designation</span></a></li>


                    <li class="nav-item"><a href="<?= base_url(); ?>Education"><i class="fa-lg fa fa-book"
                                aria-hidden="true"></i><span class="item-name">&nbsp;Education</span></a></li>

                    <li class="nav-item"><a href="<?= base_url(); ?>Master/emptype"><i class="fa-lg fas fa-user-tie"
                                aria-hidden="true"></i><span class="item-name">&nbsp;Employee Type</span></a></li>
                ...
                <div class="d-flex" id="wrapper">
                    ...
                    <ul class="childNav" data-parent="widgets">
                        ...
                        <li class="nav-item"><a href="<?= base_url(); ?>Opening/edit"><i
                                    ...
                                    class="item-name">&nbsp;&nbsp;Edit Opening</span></a></li>
                        <li class="nav-item"><a href="<?= base_url(); ?>Opening/verify"><i
                                    class="fa fa-lg fa-check-square animtxt" aria-hidden="true"></i><span
                                    class="item-name">&nbsp;&nbsp;Verify Opening</span></a></li>
                        <li class="nav-item"><a href="<?= base_url(); ?>Opening/unverify"><i
                                    class="fas fa-times-circle fa-lg animtxt" aria-hidden="true"></i><span
                                    class="item-name">&nbsp;&nbsp;Unverify&nbsp;Opening</span></a></li>
                        <li class="nav-item"><a href="<?= base_url(); ?>Opening/Deactivateopening"><i
                                    class="fas fa-trash fa-lg animtxt" aria-hidden="true"></i><span
                                    class="item-name">&nbsp;&nbsp;Deactive&nbsp;Opening</span></a></li>
                        <li class="nav-item"><a href="<?= base_url(); ?>Opening/delete"><i
                                    class="fas fa-trash fa-lg animtxt" aria-hidden="true"></i><span
                    ...
                    <ul class="childNav" data-parent="website">
                        <li class="nav-item"><a href="<?= base_url(); ?>Website/course"><i
                                    class="fa-lg fas fa-plus-circle animtxt"></i>&nbsp;&nbsp;Add Course</span></a></li>
                        <li class="nav-item"><a href="<?= base_url(); ?>Website/modifycourse"><i
                                    class="fa-lg fas fa-pen-square animtxt"></i>&nbsp;&nbsp;Edit Course</span></a></li>
                        <li class="nav-item"><a href="<?= base_url(); ?>Website/video"><i
                                    class="fa-lg fas fa-plus-circle animtxt"></i>&nbsp;&nbsp;Video</span></a></li>
                        <li class="nav-item"><a href="<?= base_url(); ?>Website/editvideo"><i
                                    class="fa-lg fas fa-pen-square animtxt"></i>&nbsp;&nbsp;Edit Video</span></a></li>
                        <li class="nav-item"><a href="<?= base_url(); ?>Website/photo"><i
                                    class="fa-lg fas fa-plus-circle animtxt"></i>&nbsp;&nbsp;Photo</span></a></li>
                        <li class="nav-item"><a href="<?= base_url(); ?>Website/editphoto"><i
                                    class="fa-lg fas fa-pen-square animtxt"></i>&nbsp;&nbsp;Edit Photo</span></a></li>
                        <li class="nav-item"><a href="<?= base_url(); ?>Website/mainslider"><i
                                    class="fa-lg fas fa-plus-circle animtxt"></i>&nbsp;&nbsp;Main Slider</span></a></li>
                        <li class="nav-item"><a href="<?= base_url(); ?>Website/editmainslider"><i
                                    class="fa-lg fas fa-pen-square animtxt"></i>&nbsp;&nbsp;Edit Main Slider</span></a>
                        </li>
                    </ul>

                    <!-- chartjs-->
                    <ul class="childNav" data-parent="charts">
                        <li class="nav-item"><a href="<?= base_url(); ?>SelectStudent"><i class="fa-lg fa fa-list-alt"
                                    aria-hidden="true"></i><span class="item-name">&nbsp;&nbsp;Selected List</span></a>
                        </li>
                        <li class="nav-item"><a href="<?= base_url(); ?>SelectStudent/branch"><i
                                    class="fa-lg fa fa-list-ul" aria-hidden="true"></i><span
                                    class="item-name">&nbsp;&nbsp;Branch List</span></a></li>
                        <li class="nav-item dropdown-sidemenu"><a href="<?= base_url(); ?>SelectStudent/department"><i
                                    class="fa-lg fa fa-th-list" aria-hidden="true"></i><span
                                    class="item-name">&nbsp;&nbsp;DepartmentList</span></a></li>

                        <li class="nav-item dropdown-sidemenu"><a href="<?= base_url(); ?>SelectStudent/company"><i
                                    class="fa-lg fa fa-list" aria-hidden="true"></i><span
                                    class="item-name">&nbsp;&nbsp;Company List</span></a></li>
                    </ul>
                ...
                <li class="nav-item"><a href="<?= base_url(); ?>Website"><i class="fa-lg fa fa-university" aria-hidden="true"></i><span class="item-name">&nbsp;Home</span></a></li>                   
                    ...
                    <ul class="childNav" data-parent="sessions">
                        <li class="nav-item"><a href="http://demos.ui-lib.com/gull/html/sessions/signin.html"><i
                                    class=" nav-icon nav-icon i-Checked-User"></i><span
                                    class="item-name">Signin</span></a></li>
                        <li class="nav-item"><a href="http://demos.ui-lib.com/gull/html/sessions/signup.html"><i
                                    class=" nav-icon nav-icon i-Add-User"></i><span class="item-name">Signup</span></a>
                        </li>
                        <li class="nav-item"><a href="http://demos.ui-lib.com/gull/html/sessions/forgot.html"><i
                                    class=" nav-icon nav-icon i-Find-User"></i><span class="item-name">Forgot</span></a>
                        </li>
                    </ul>
                    <ul class="childNav" data-parent="others">
                        <li class="nav-item"><a href="http://demos.ui-lib.com/gull/html/sessions/not-found.html"><i
                                    class=" nav-icon nav-icon i-Error-404-Window"></i><span
                                    class="item-name">NotFound</span></a></li>
                        <li class="nav-item"><a href="<?= base_url(); ?>user.profile.html"><i
                                    class=" nav-icon nav-icon i-Male"></i><span class="item-name">UserProfile</span></a>
                        </li>
                        <li class="nav-item"><a class="open" href="<?= base_url(); ?>blank.html"><i
                                    class=" nav-icon nav-icon i-File-Horizontal"></i><span
                                    class="item-name">BlankPage</span></a></li>
                    </ul>
                </div>
