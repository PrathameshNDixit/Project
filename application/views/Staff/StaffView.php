...
<div class="main-content-wrap sidenav-open d-flex flex-column">
    ...
    <div class="main-content">
        ...
        <div class="row card p-3">
                        ...
                        <form id="Form" action="" method="POST">
                            <div class="row p-3">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    ...
                                    <input type="varchar" class="form-control" id="BranchName" name="BranchName" required
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    ...
                                    <input type="varchar" class="form-control" id="EmployeeName" name="EmployeeName" required
                                        value="<?php if (!empty($data))
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    <label>Message</label>
                                    <input type="varchar" class="form-control" id="Message" name="Message" required
                                        value="<?php if (!empty($data))
                                            echo $data[0]->Message; ?>" />
            ...
            <select name="MessageType" id="MessageType" data-control="select2" data-hide-search="true" class="js-states form-control nav selectpicker">
          ...
          <div class="form-group custom-dropdown  mt-0 col-lg-3 ">
            ...
            <select name="Source" id="Source" data-control="select2" data-hide-search="true" class="js-states form-control nav selectpicker">
                                            <!-- <select class="form-control" name="RefType"> -->
                                                <option value="MLA">MLA</option>
                                                <option value="Chief Minister">Chief Minister</option>
                                                <option value="Prime Minister">Prime Minister</option>
                                ...
                                <?php if (!empty($data)) {
                                    echo "<input name='StaffID' id='StaffID' value='" . $data[0]->StaffID . "' type='hidden' />";
                                }
                                ?>
        ...
        <script src="<?php echo base_url('web_resources'); ?>/dist/js/controllers/Staff_create.js"></script>
