                            ...
                            <table class=" display nowrapdisplay table table-striped table-bordered" id="example"
                                ...
                                <tbody>
                                    ...
                                    for ($i = 0; $i < count($data); $i++) {
                                        echo '<tr>';
                                        echo '<td><a href="' . base_url() . 'Staff/create/' . $data[$i]->StaffID . '"><i class="fas fa-eye" style="font-size: 16px;"></i></a></td>';
                                        echo '<td>' . $data[$i]->StaffID . '</td>';
                                        echo '<td>' . $data[$i]->BranchName . '</td>';
                                        echo '<td>' . $data[$i]->EmployeeName . '</td>';
                                        echo '<td>' . $data[$i]->Message . '</td>';
                                        echo '<td>' . $data[$i]->Date . '</td>';
                                        echo '<td>' . $data[$i]->MessageType . '</td>';
                                        echo '<td>' . $data[$i]->Source . '</td>';
                                        echo '</tr>';
                                    }
                                    ?>
                                </tbody>
