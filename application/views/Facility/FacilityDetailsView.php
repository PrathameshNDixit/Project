...
<div class="main-content-wrap sidenav-open d-flex flex-column">
    ...
    <div class="main-content">
        <div class="breadcrumb">
            ...
            <h4>Banquet Facility Information</h4>
            <!-- <ul>
                            ...
                            <table class=" display nowrapdisplay table table-striped table-bordered" id="example"
                                ...
                                <tbody>
                                    ...
                                    for ($i = 0; $i < count($data); $i++) {
                                        echo '<tr>';
                                        echo '<td><a href="' . base_url() . 'Facility/create/' . $data[$i]->FacilityId . '"><i class="fas fa-eye" style="font-size: 16px;"></i></a></td>';
                                        echo '<td>' . $data[$i]->FacilityId. '</td>';
                                        echo '<td>' . $data[$i]->BanquetFacilityName . '</td>';
                                        echo '<td>' . $data[$i]->FacilityRate . '</td>';
