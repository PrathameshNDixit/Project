...
<div class="main-content-wrap sidenav-open d-flex flex-column">
    ...
    <div class="main-content">
                        ...
                        <form id="Form" action="" method="POST">
                            ...
                            <div class="row p-3">
                                <div class="col-12 my-heading">
                                    <div> Banquet Package Information</div>
                                    <hr>
                                </div>

                                <div class="col-sm-12 col-md-6 col-lg-4 col-xl-4  form-group  mt-0">
                                    <label>Banquet package Name</label>
        ...
        <script src="<?php echo base_url('web_resources'); ?>/dist/js/controllers/BanquetPkg_create.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/select2/4.0.6-rc.0/js/select2.min.js"></script>
        <script src="<?php echo base_url('web_resources'); ?>/dist/js/controllers/banquetpatti1.js"></script>
