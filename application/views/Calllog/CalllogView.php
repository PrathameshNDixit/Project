...
<div class="main-content-wrap sidenav-open d-flex flex-column">
    ...
    <div class="main-content">
                        ...
                        <form id="Form" action="" method="POST">
                            <div class="row p-3">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    ...
                                    <input type="text" class="form-control" id="CallType" name="CallType" required
                                        value="<?php if (!empty($data))
                                            echo $data[0]->CallType; ?>" />

                                </div>

                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    <label>CallPerson  Name</label>
                                    <input type="text" class="form-control" id="CallPersonName" name="CallPersonName" required
                                        value="<?php if (!empty($data))
                                            echo $data[0]->CallPersonName; ?>" />
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    ...
                                    <input type="date" class="form-control" id="CallDate" name="CallDate" required
                                        value="<?php if (!empty($data))
                                            echo $data[0]->CallDate; ?>" />

                                </div><br><br><br>
                                

                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    <label>Call Reason Type </label>
                                    <input type="text" class="form-control" id="CallReasonType" name="CallReasonType" required
                                        value="<?php if (!empty($data))
                                            echo $data[0]->CallReasonType; ?>" />
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    ...
                                    <input type="time" class="form-control" id="CallTime" name="CallTime" required
                                        value="<?php if (!empty($data))
                                            echo $data[0]->CallTime; ?>" />

                                </div>

                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    <label> Next Follow Date</label>
                                    <input type="date" class="form-control" id="NextFollowDate" name="NextFollowDate" required
                                        value="<?php if (!empty($data))
                                            echo $data[0]->NextFollowDate; ?>" />
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    ...
                                    <textarea class="form-control" name="CallDescription" id="CallDescription" cols="4" rows="3" value="<?php if (!empty($data))
                                        echo $data[0]->CallDescription; ?>"></textarea>
                                </div>

                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    <label>Feedback</label>
                                    <textarea class="form-control" name="Feedback" id="Feedback" cols="4" rows="3" value="<?php if (!empty($data))
                                        echo $data[0]->Feedback; ?>"></textarea>
                                </div>
        ...
        <script src="<?php echo base_url('web_resources'); ?>/dist/js/controllers/calllog_create.js"></script>
