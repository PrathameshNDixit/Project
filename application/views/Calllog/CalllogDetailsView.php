                            ...
                            <table class=" display nowrapdisplay table table-striped table-bordered" id="example"
                                ...
                                <tbody>
                                    ...
                                    for ($i = 0; $i < count($data); $i++) {
                                        echo '<tr>';
                                        echo '<td><a href="' . base_url() . 'Calllog/create/' . $data[$i]->CalllogId . '"><i class="fas fa-eye" style="font-size: 16px;"></i></a></td>';
                                        echo '<td>' . $data[$i]->CalllogId . '</td>';
                                        echo '<td>' . $data[$i]->CallType . '</td>';
                                        echo '<td>' . $data[$i]->CallPersonName . '</td>';
                                        echo '<td>' . $data[$i]->EmployeeName . '</td>';
                                        echo '<td>' . $data[$i]->CallDate . '</td>';
                                        echo '<td>' . $data[$i]->CallReasonType . '</td>';
                                        echo '<td>' . $data[$i]->CallTime . '</td>';
                                        echo '<td>' . $data[$i]->NextFollowdate . '</td>';
                                        echo '<td>' . $data[$i]->CallDescription . '</td>';
                                        echo '<td>' . $data[$i]->Feedback . '</td>';
