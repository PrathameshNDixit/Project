...
<div class="main-content-wrap sidenav-open d-flex flex-column">
    ...
    <div class="main-content">
        <div class="breadcrumb">
            ...
            <h4>Health Club Type Information</h4>
            <!-- <ul>
                            ...
                            <table class=" display nowrapdisplay table table-striped table-bordered" id="example"
                                ...
                                <thead> <!-- Button trigger modal -->
                                    ...
                                    <tr>
                                        <!-- <th>Sr.No</th> -->
                                        <th>Action</td>
                                        <th>Health Club Id</th>
                                        <th>Health Club Type Name</th>
                                ...
                                <tbody>
                                    ...
                                    for ($i = 0; $i < count($data); $i++) {
                                        echo '<tr>';
                                        echo '<td><a href="' . base_url() . 'HealthClub/create/' . $data[$i]->HealthClubId . '"><i class="fas fa-eye" style="font-size: 16px;"></i></a></td>';
                                        echo '<td>' . $data[$i]->HealthClubId. '</td>';
                                        echo '<td>' . $data[$i]->HealthClubName . '</td>';
