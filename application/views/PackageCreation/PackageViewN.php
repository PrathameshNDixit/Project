        ...
        <div class="main-content-wrap sidenav-open d-flex flex-column">
            ...
            <div class="main-content">
              <div class="breadcrumb">
                <img height="50px" width="500px" src="<?php echo base_url() ?>Assets\images\ribbon.png ">
                        ...
                        <div class="row p-3">
                            ...
                            <div class="col-md-2 form-group  mt-0">
                                    ...
                                    <input class="form-control" id="amount" type="number" name="amount" value="<?php if(!empty($dataa[0]->amount)){echo $dataa[0]->amount;}?>" />
                                            ...
                                            <button class="btn btn-md btn-warning text-white" type="button" name="cancle" id="cancle"><i class="fa-sharp fa-solid fa-pen-to-square"><a href="<?php echo base_url();?>Package/index" style="color:white;"></i> Edit</button>
...
<script  src="<?php echo base_url('web_resources');?>/dist/js/controllers/Package_create.js"></script>
