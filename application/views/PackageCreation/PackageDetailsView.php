                            ...
                            <table class=" display nowrapdisplay table table-striped table-bordered" id="example"
                                ...
                                <thead> <!-- Button trigger modal -->
                                    ...
                                    <tr>
                                        ...
                                        <th>Id</th>
                                        <th>Package Name</th>
                                        <th>Health Club Type</th>
                                        <th>Health Club Duration</th>
                                        <th>Trainee Category</th>
                                        <th>Features</th>
                                        <th>Rate</th>
                                        <th>Amount</th>
                                ...
                                <tbody>
                                    ...
                                    for ($i = 0; $i < count($data); $i++) {
                                        echo '<tr>';
                                        echo '<td><a href="' . base_url() . 'Package/create/' . $data[$i]->PackageId . '"><i class="fas fa-eye" style="font-size: 16px;"></i></a></td>';
                                       
                                        echo "<td>".$data[$i]->PackageId."</td>";
                                        echo "<td>".$data[$i]->PackageName."</td>";
                                        echo "<td>".$data[$i]->HCType."</td>";
                                        echo "<td>".$data[$i]->HCDuration."</td>";
                                        echo "<td>".$data[$i]->rate."</td>";
                                        echo "<td>".$data[$i]->TraineeCategory."</td>";
