...
<div class="main-content-wrap sidenav-open d-flex flex-column">
    ...
    <div class="main-content">
        <div class="breadcrumb">
            ...
            <h4>Discount Type Information</h4>
            <!-- <ul>
                            ...
                            <table class=" display nowrapdisplay table table-striped table-bordered" id="example"
                                ...
                                <tbody>
                                    ...
                                    for ($i = 0; $i < count($data); $i++) {
                                        echo '<tr>';
                                        echo '<td><a href="' . base_url() . 'InvDiscount/create/' . $data[$i]->HealthClubId . '"><i class="fas fa-eye" style="font-size: 16px;"></i></a></td>';
                                        echo '<td>' . $data[$i]->InvDiscountId. '</td>';
                                        echo '<td>' . $data[$i]->InvDurationName . '</td>';
                                        
                                        echo '<td>' . $data[$i]->Percentage. '</td>';
