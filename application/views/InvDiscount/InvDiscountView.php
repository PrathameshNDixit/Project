...
<div class="main-content-wrap sidenav-open d-flex flex-column">
    ...
    <div class="main-content">
                        ...
                        <form id="Form" action="" method="POST">
                            <div class="row p-3">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    ...
                                    <input type="text"placeholder="Enter Discount Type Name" class="form-control" id="InvDiscountName" name="InvDiscountName" required
                                        value="<?php if (!empty($data))
                                            echo $data[0]->InvDiscountName; ?>" />

                                </div>

                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    <label>Percentage</label>
                                    <input type="text"placeholder="Enter Percentage" class="form-control" id="Percentage" name="Percentage" required
                                        value="<?php if (!empty($data))
                                            echo $data[0]->Percentage; ?>" />
                                ...
                                <?php if (!empty($data)) {
                                    echo "<input name='InvDiscountId' id='InvDiscountId' value='" . $data[0]->InvDiscountId . "' type='hidden' />";
                                }
                                ?>
        ...
        <script src="<?php echo base_url('web_resources'); ?>/dist/js/controllers/InvDiscount_create.js"></script>
