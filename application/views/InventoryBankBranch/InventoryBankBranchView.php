...
<div class="main-content-wrap sidenav-open d-flex flex-column">
    ...
    <div class="main-content">
        ...
        <div style="margin-top:-20px;" class=" border-top"></div>
                        ...
                        <form id="Form" action="" method="POST">
                            <div class="row p-3">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    ...
                                    <input type="text" class="form-control" placeholder="Enter Bank Branch Name"id="BranchName" name="BranchName" required
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    <label>Bank Branch Short Name</label>
                                    <input type="text" class="form-control"placeholder="Enter Bank Branch Short Name" id="BranchShortName" name="BranchShortName" required
                                        value="<?php if (!empty($data))
                                            echo $data[0]->BranchShortName; ?>" />

                                </div>

                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    <label>IFSC Code</label>
                                    <input type="text" class="form-control"placeholder="Enter IFSC Code" id="IFSCCode" name="IFSCCode" required
                                        value="<?php if (!empty($data))
                                            echo $data[0]->IFSCCode; ?>" />

                                </div>
                                <div class="form-group custom-dropdown  mt-0 col-lg-3 ">
                                         <label for="">Bank Name</label>
                                       <select name="BnakName" id="BankName" data-control="select2" data-hide-search="true" class="js-states form-control nav selectpicker">
                                            <!-- <select class="form-control" name="RefType"> -->
                                                <option value="MLA">---Select---</option>
                                                <option value="Chief Minister">Bank Of India</option>
                                                <option value="Prime Minister">Bank Of Maharshtra</option>
                                                <option value="President">HDFC Bank</option>
                                 </select>
                                </div><br><br><br>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    <label>Address</label>
                                    <textarea class="form-control" name="Address"placeholder="Enter Address" id="Address" cols="4" rows="3" value="<?php if (!empty($data))
                                        echo $data[0]->Address; ?>"></textarea>
                                </div>


                                <?php if (!empty($data)) {
                                    echo "<input name='CalllogId' id='CalllogId' value='" . $data[0]->CalllogId . "' type='hidden' />";
                                }
                                ?>
        ...
        <script src="<?php echo base_url('web_resources'); ?>/dist/js/controllers/InventoryBranchBank_create.js"></script>
