                        ...
                        <form id="Form" action="" method="POST">
                            <div class="row p-3">
                                ...
                                <input type="hidden" name="id" id="EnquiryId"
                                    value="<?php if (!empty($dataa[0]->EnquiryId)) {
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    ...
                                    <input class="form-control" id="EnquiryName" type="text" name="EnquiryName"
                                        value="<?php if (!empty($dataa[0]->EnquiryName)) {
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    ...
                                    <input class="form-control" id="EnquiryTime" type="Time" name="EnquiryTime"
                                        value="<?php if (!empty($dataa[0]->EnquiryTime)) {
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    ...
                                    <input class="form-control" id="Date" type="Date" name="Date"
                                        value="<?php if (!empty($dataa[0]->Date)) {
                                            echo $dataa[0]->Date;
                                        } ?>" />
                                </div>
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    ...
                                    <input class="form-control" id="RefName" type="text" name="RefName"
                                        value="<?php if (!empty($dataa[0]->RefName)) {
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    ...
                                    <input class="form-control" id="RefNo" type="number" name="RefNo"
                                        value="<?php if (!empty($dataa[0]->RefNo)) {
                                            echo $dataa[0]->RefNo;
                                        } ?>" />
                                </div>
