...
<div class="main-content-wrap  d-flex flex-column">
    ...
    <div class="main-content">
        <div class="breadcrumb">
            ...
            <h4>Health Club Duration Information
</h4>
            <!-- <ul>
                        ...
                        <form id="Form" action="" method="POST">
                            <div class="row p-3">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    <label>Health Club Duration Name</label>
                                    <input type="text"placeholder="Enter Health Club Duration Name" class="form-control" id="HealthDurationName" name="HealthDurationName" required
                                        value="<?php if (!empty($data))
                                            echo $data[0]->HealthDurationName; ?>" />
                                ...
                                <?php if (!empty($data)) {
                                    echo "<input name='HealthDurationId' id='HealthDurationId' value='" . $data[0]->HealthDurationId . "' type='hidden' />";
                                }
                                ?>
        ...
        <script src="<?php echo base_url('web_resources'); ?>/dist/js/controllers/HealthDuration_create.js"></script>
