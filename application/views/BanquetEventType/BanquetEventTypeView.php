...
<div class="main-content-wrap sidenav-open d-flex flex-column">
    ...
    <div class="main-content">
        <div class="breadcrumb">
            ...
            <h4>Banquet Event Type Information
</h4>
            <!-- <ul>
                        ...
                        <form id="Form" action="" method="POST">
                            <div class="row p-3">
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-3 col-xl-3  form-group  mt-0">
                                    <label>Banquet Event Type Name</label>
                                    <input type="text" class="form-control" placeholder="Enter Banquet Event Type Name"id="EventName" name="EventName" required
        ...
        <script src="<?php echo base_url('web_resources'); ?>/dist/js/controllers/BanquetEvent_create.js"></script>
