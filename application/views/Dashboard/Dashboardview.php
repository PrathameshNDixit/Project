        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                    <div class="card-body text-center"><img src="Assets/images/registration.png" height="60px"
                            width="60px" alt="">
                        <div class="content">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                    <div class="card-body text-center"><img src="Assets/images/businessman.png" height="60px"
                            width="60px" alt="">
                        <div class="content">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                    <div class="card-body text-center"><img src="Assets/images/vacancy.png" height="60px" width="60px"
                            alt="">
                        <div class="content">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="card card-icon-bg card-icon-bg-primary o-hidden mb-4">
                    <div class="card-body text-center"><img src="Assets/images/buildings.png" height="60px" width="60px"
                            alt="">
                        <div class="content">
