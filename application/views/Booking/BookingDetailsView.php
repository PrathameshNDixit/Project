                            ...
                            <table class=" display nowrapdisplay table table-striped table-bordered" id="example"
                                ...
                                <tbody>
                                    ...
                                    for ($i = 0; $i < count($data); $i++) {
                                        echo '<tr>';
                                        echo '<td><a href="' . base_url() . 'Booking/create/' . $data[$i]->BookingId . '"><i class="fas fa-eye" style="font-size: 16px;"></i></a></td>';
                                       
                                        echo "<td>".$data[$i]->BookingId."</td>";
                                        echo "<td>".$data[$i]->CustomerName."</td>";
                                        echo "<td>".$data[$i]->CustomerId."</td>";
