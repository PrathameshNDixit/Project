...
function saveperform() {
    ...
    var CallPersonName = $('#PersonName').val();
    var EmployeeName = $('#EmployeeName').val();
    var CallDate = $('#CallDate').val();
    var CallReasonType = $('#CallReasonType').val();
    ...
    if (CallType == ""||CallPersonName==""|| EmployeeName==""||CallDate==""|| CallReasonType==""||CallTime==""||NextFollowDate==""||CallDescription==""||Feedback=="") {
        // alert("requird");
        swal({
            title: "",
