...
addbtn2.addEventListener("click", () => {
    ...
    const MobApp = document.getElementById("MobApp").value;
    const TrId = document.getElementById("TrId").value;
	...
	var td2 = document.createElement("td");
	td2.appendChild(document.createTextNode(PayType));
    var td3 = document.createElement("td");
    td3.appendChild(document.createTextNode(MobApp));
    var td4 = document.createElement("td");
    td4.appendChild(document.createTextNode(TrId));
    var td5 = document.createElement("td");
    td5.appendChild(document.createTextNode(Bank));
    var td6 = document.createElement("td");
    td6.appendChild(document.createTextNode(ChequeNo));
    var td7 = document.createElement("td");
    td7.appendChild(document.createTextNode(ChequeDate));
    var td8 = document.createElement("td");
    td8.appendChild(document.createTextNode(PaymentDate));
    var td9 = document.createElement("td");
    td9.appendChild(document.createTextNode(PaidAmount));
	var th = document.createElement("th");
